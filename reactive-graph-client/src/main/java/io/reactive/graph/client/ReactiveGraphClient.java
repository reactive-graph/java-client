package io.reactive.graph.client;
...
@SpringBootApplication(
        scanBasePackageClasses = { ReactiveGraphClient.class, GraphqlClientUtils.class, QueryExecutor.class }
)
@EnableGraphQLRepositories({ "io.reactive.graph.repository" })
@Slf4j
public class ReactiveGraphClient {

    public static void main(String[] args) {
        SpringApplication.run(ReactiveGraphClient.class, args);
    }
